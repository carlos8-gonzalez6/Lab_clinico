...
Partial Class nuevo_empleado
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtempleadonombre.TabIndex = 1
        '
        'Label2
        '
        ...
        Me.txtempleadoapellido.TabIndex = 3
        '
        'Label3
        '
        ...
        Me.txtdireccionempleado.TabIndex = 10
        '
        'Label6
        '
        ...
        Me.txtempleadotelef.TabIndex = 12
        '
        'Label7
        '
        ...
        Me.btnguardar_emple_nuevo.TabIndex = 24
        ...
        Me.btncancel_edit_empleado.TabIndex = 25
